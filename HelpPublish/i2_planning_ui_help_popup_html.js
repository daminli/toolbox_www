...
function hmshowPopup(e, txt, stick) {
  var tip = '<table  cellpadding="3" cellspacing="0" style="background-color:#FFFFFF; border:1px solid #FF0000; border-collapse:collapse;"><tr valign=top><td>'+ txt + '<\/td><\/tr><\/table>';
